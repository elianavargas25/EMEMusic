                            ...
                            <div class="container">
                                ...
                                <div class="table container">
                                    <div class="col">
                                        ...
                                        <table  border="0" id="customer" class="table">
                                            <tbody class="table-responsive">
                                                <tr class="active">
                                                    <td><div class="reply_form_label" aria-hidden="true">Medio de difusiÃ³n</div></td>
                                                    <td ><div class="reply_form_label" aria-hidden="true">Cantidad reproducciones</div></td>
                                                    <td ><div class="reply_form_label" aria-hidden="true">Total </div></td>
                                                </tr> 
