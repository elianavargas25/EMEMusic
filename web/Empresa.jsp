                            ...
                            <div class="reply_form_container">
                                <form id="reply_form" action="post">
                                    <div>
                                        ...
                                        <input id="Document" class="input_field reply_form_name" type="text" placeholder="Número de Documento *" required="required" data-error="Name is required.">
                                    </div>
                                    <div>
                                        ...
                                        <input id="PagoPorOperacion" class="input_field reply_form_name" type="text" placeholder="Pago por Operación *" required="required" data-error="Name is required."><br>
